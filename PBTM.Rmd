...
After the data to be used in the model calculation is passed to the TreatData table, now define the model to be calculated. At this time the following models are available for calculation: (1) Hydropriming; () 
