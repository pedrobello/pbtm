...
## Model Calculation and plot: Function CALCnPLOTModel()

Calculate model parameters and plot raw and curves predicted by the selected model. Additionaly, model parameters and correlations values are informed in the plot. 
...
### Hydrotime time suboptimal model
```{r warning=FALSE, message=FALSE, results='hide'}
...
### Hydrotime time supra-optimal model
```{r warning=FALSE, message=FALSE, results='hide'}
TreatData <- subset(TomatoQ2Dt, Treat.ID == 1 & Germ.temp==25)
DefineModel(2.1)
```
