...
#### Additional plot option for priming models.
```{r warning=FALSE}
PlotPrimingMatrix()
```
Example of priming matrix with germination rates (GR50) over the priming treatments including water potential (WP), priming duration (Duration) and priming temperature (represented by the different surface colors).
